...
import { DompileRenderer } from '../integration/dompileRenderer';
import { ConfigLoader } from '../integration/configLoader';
import { ExtensionContext } from '../types';

export class DompilePreviewProvider implements vscode.WebviewPanelSerializer {
    private panels = new Map<string, vscode.WebviewPanel>();
    private renderer: DompileRenderer;
    ...
    constructor(context: ExtensionContext) {
        ...
        this.renderer = new DompileRenderer(workspaceRoot);
        ...
        context.extensionContext.subscriptions.push(
            vscode.window.registerWebviewPanelSerializer('dompile.preview', this)
        );
...
<body>
    <div class="error">
        <h2>Preview Error</h2>
        <p>Failed to render DOMpile preview:</p>
