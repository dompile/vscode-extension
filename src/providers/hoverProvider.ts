...
export class DompileHoverProvider implements vscode.HoverProvider {
    ...
    private async createIncludeHover(
        ...
        // Header
        markdown.appendMarkdown(`### ${statusIcon} DOMpile Include\n\n`);
        ...
        if (exists) {
            ...
            if (fs.existsSync(dir)) {
                markdown.appendMarkdown(`[Create File](command:dompile.createIncludeFile?${encodeURIComponent(JSON.stringify([resolvedPath]))})\n`);
            }
        }
    ...
    private async createTemplateHover(
        ...
        markdown.appendMarkdown(`### ${statusIcon} DOMpile Template Extension\n\n`);
    ...
    private async createSlotHover(
        ...
        markdown.appendMarkdown(`### 🎯 DOMpile Slot\n\n`);
